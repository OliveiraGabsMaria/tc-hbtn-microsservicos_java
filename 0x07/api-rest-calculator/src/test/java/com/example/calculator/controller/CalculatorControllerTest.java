...
public class CalculatorControllerTest {
    ...
    @Test
    void calculeDayBetweenDay() throws Exception {
    	String localDate1 = "2022-03-01";
    	String localDate2 = "2022-03-24";
    	String url = "/calculator/calculeDayBetweenDate?localDate1=" + localDate1 + "&localDate2=" + localDate2;
    	
    	RequestBuilder request = get(url);
    	MvcResult result = mvc.perform(request).andReturn();
    	assertEquals("23", result.getResponse().getContentAsString());
    }
